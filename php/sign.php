...
<form method="POST">
      <div class="sign-up-htm">
        ...
        <div class="group">
          ...
          <input id="pass" type="text" class="input" name="email" name="email">
        </div>
        <div class="group">
...
$connection = connectDb("localhost","root"," ","rahbanipharmacy");
...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    $result= addUser($connection,"user",$_POST["pass1"],$_POST["pass2"],$_POST["username"],$_POST["email"]);
    if($result==-1)
    {
        alert("user Exists");
    }
...
{
    $result= signInUser($connection,"user",$_GET["username"],$_GET["password"]);
